...
(23, 'Nieme capteur', 1, 0, 5646544, 3, 1, 2, 1, 1);
...
(1, 'Capteur cassé', 'Bonjour, je ne comprends pas un de mes capteurs affiche une valeur improbable. Pouvez-vous m\'aidez? ', '2019-05-01 12:12:12');
...
(1, 'MENVUSA', 'Gérard', 'gerard.menvusa@gmail.com', '06 66 77 88 99', '1990-01-01', '$2y$10$otE9JOcd.ThVKQKmiVNLQ.kF6AAdmtKrGw8nYhbHISphPOUCknB4C', 1, 'Que voulez-vous manger ?', 'Des nouilles', 1),
(2, 'HIFFY', 'Eugène', 'eugene.hiffy@gmail.com', '07 87 26 12 12', '1998-01-31', '$2y$10$otE9JOcd.ThVKQKmiVNLQ.kF6AAdmtKrGw8nYhbHISphPOUCknB4C', 1, 'Que voulez-vous manger ?', 'Des patates', 1),
(3, 'HIC', 'Bazil', 'bazil.hic@gmail.com', '07 54 64 12 14', '1987-07-05', '$2y$10$otE9JOcd.ThVKQKmiVNLQ.kF6AAdmtKrGw8nYhbHISphPOUCknB4C', 1, 'Que voulez-vous prendre ?', 'Un pari sur l\'avenir', 1),
(4, 'TIME', 'Vic', 'vic.time@gmail.com', '06 78 45 40 17', '2000-07-09', '$2y$10$otE9JOcd.ThVKQKmiVNLQ.kF6AAdmtKrGw8nYhbHISphPOUCknB4C', 1, 'Que voulez-vous prendre ?', 'Ton argent', 2),
(5, 'Olivier', 'Raph', 'traingwon2015@gmail.com', NULL, '1998-09-07', '$2y$10$otE9JOcd.ThVKQKmiVNLQ.kF6AAdmtKrGw8nYhbHISphPOUCknB4C', 1, NULL, NULL, 1);
