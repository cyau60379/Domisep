...
INSERT INTO `actionneur_capteur` (`id`, `nom`, `Etat`, `Actif`, `NumeroSerie`, `id_element_catalogue`, `id_CeMac`,
                                  `id_piece`, `id_utilisateur`, `id_categorie`)
VALUES
...
INSERT INTO `article_faq` (`id`, `Titre`, `Contenu`)
VALUES
(1, 'Qu’est-ce qu’est la domotique ?',
 'La domotique sans fil permet de superviser, d\'automatiser, de programmer et de coordonner le fonctionnement de vos lampes et/ou appareils électriques.'),
(2, 'Quelles sont les technologies utilisées par la gamme de domotique sans fil NIDS ?',
 'La gamme de domotique sans fil NIDS permettra la simplification de vos travaux d’innovation de votre domicile. Notre gamme utilise les connexions Wi-FI, Bluetooth, et cellulaires afin de vous permettre d’avoir un service le plus agréable et efficace possible.'),
(3, 'Ces produits sont-ils compatibles avec mon équipement ?',
 'Nos produits sont compatibles avec non seulement tout type d’aménagement de domicile : appartement ou maison, mais aussi avec n’importe quel appareil capable d’avoir accès à une page web.'),
(4, 'Comment ajouter un nouveau capteur à mon équipement ?',
 'Afin d’ajouter un nouveau capteur à votre équipement, il vous suffit de le lier avec votre compte client à l’aide de son numéro de série sur la page de gestion des capteurs accessible par la page de gestion de profil.'),
(5, 'Comment fonctionne votre système ?',
 'Les ordres données par vous-même à l’aide de votre page web gestion des capteurs se transmettent à partir de nos serveurs à l’aide la connexion internet de votre routeur qui diffuse ensuite en Wi-Fi, Bluetooth, or Ethernet.'),
(6, 'Que faire si j’ai oublié mon mot de passe ?',
 'Une fonctionnalité “Mot de passe oublié” est disponible sur le site, ce qui vous permet de réinitialiser votre mot de passe à partir d’un mail automatique envoyé à votre adresse e-mail liée à votre compte.'),
(7, 'Que se passe-t-il si une personne non désirée est détectée par vos capteurs ?',
 'Dans un premier temps, un boîtier est placé à l’entrée pour que vous puissiez rentrer facilement sans une longue procédure de vérification. En revanche, si le code entré n’est pas bon au bout de 30 secondes, un standardiste appelle votre maison par le fixe du domicile et demande un code de vérification. Si le code répondu est faux, ou si il n’y a pas de réponse, le client et la police sont immédiatement contactés.');
...
INSERT INTO `cemac` (`id`, `Nom`, `Etat`, `id_logement`)
VALUES
  (1, 'CeMACC', 1, 1);
...
INSERT INTO `donnees` (`id`, `Date_heure_reception`, `Valeur`, `id_actionneur_capteur`)
VALUES
...
INSERT INTO `element_catalogue` (`id`, `Type`, `Description`, `Photo`)
VALUES
(1, 'Température', 'Ce capteur permet de mesurer la température dans la pièce dans laquelle il se situe',
 'Temperature'),
...
INSERT INTO `heritage` (`id`, `id_utilisateur_prim`, `id_utilisateur_sec`, `id_logement`)
VALUES
  (1, 4, 2, 2),
  (2, 4, 3, 3);
...
INSERT INTO `logement` (`id`, `Adresse`, `Temperature_consigne`, `id_utilisateur`)
VALUES
...
INSERT INTO `piece` (`id`, `Nom`, `id_logement`)
VALUES
...
INSERT INTO `type_utilisateur` (`id`, `Nom`)
VALUES
  (1, 'client'),
  (2, 'gestionnaire');
...
INSERT INTO `utilisateur` (`id`, `Nom`, `Prenom`, `Adresse_mail`, `numeroTel`, `Date_naissance`, `Mot_de_passe`, `Etat`,
                           `Question_verif`, `Reponse_verif`, `id_type_utilsateur`)
VALUES
(1, 'MENVUSA', 'Gérard', 'gerard.menvusa@gmail.com', '06 66 77 88 99', '1990-01-01', '6r&4k1S3p', 1,
 'Que voulez-vous manger ?', 'Des nouilles', 1),
(2, 'HIFFY', 'Eugène', 'eugene.hiffy@gmail.com', '07 87 26 12 12', '1998-01-31', 'M0l0lFait', 1,
 'Que voulez-vous manger ?', 'Des patates', 1),
(3, 'HIC', 'Bazil', 'bazil.hic@gmail.com', '07 54 64 12 14', '1987-07-05', 'Bi1Fr4is', 1, 'Que voulez-vous prendre ?',
 'Un pari sur l\'avenir', 1),
(4, 'Time', 'Vincent', 'vic.time@gmail.com', '06 78 45 40 17', '2000-07-09', 'TheB4nch33', 1,
 'Que voulez-vous prendre ?', 'Ton argent', 2),
(5, 'parizot', 'julien', 'julien@parizot.org', NULL, '1998-02-21',
 '$2y$10$CvFonXCnNKgT6RvOJ912MOO2aCXdjeGvBJAB.1aAj2ks.xB1wP/NG', 1, NULL, NULL, 1);
